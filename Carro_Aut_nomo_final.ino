...
#define FAROL_A 9 //Led esquerda
#define FAROL_B 8 //Led direita
...
//LDR
#define LDR A0 // Recebe dados do LDR
/*============================================================================*/
...
void loop() {
  ...
  if (luz < 600)
  {
    digitalWrite(FAROL_A, HIGH);
    digitalWrite(FAROL_B, HIGH);
    Serial.println("Farois ligados");
  }
  else
  {
    digitalWrite(FAROL_A, LOW);
    digitalWrite(FAROL_B, LOW);
    Serial.println("Farois Desligados");
  }
